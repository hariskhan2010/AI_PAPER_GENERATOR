      ...
      >
        <Card className="relative overflow-hidden border-[#0D2818] bg-[#0A0A0A] shadow-2xl shadow-black/40">
          ...
          <CardHeader className="pb-2 pt-10 text-center">
            ...
            >
              <img src="/logo.png" alt="PaperAI" className="mx-auto mb-2 h-40 w-40 object-contain" />
            </motion.div>
            <motion.div
          ...
          <CardContent className="px-8 pb-10">
            ...
            >
              ...
              <motion.p variants={itemVariants} className="text-center text-xs text-white/40">
                ...
                <Link href="/signup" className="font-medium text-[#22C55E] transition-colors hover:text-[#4ADE80]">
                  Sign Up
                </Link>
              </motion.p>
            </motion.div>
